...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/spring-limit-5c13)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-limit-5c13
```

A live public deployment of this template is available at [https://spring-limit-5c13.templates.workers.dev](https://spring-limit-5c13.templates.workers.dev)
